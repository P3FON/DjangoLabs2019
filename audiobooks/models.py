...
class Audiobook(models.Model):
    ...
    def __str__(self):
        ...
        audiobook_str += f"; length {self.format_length()}" if is_available(self.length) else ""
    ...
    def format_length(self):
        ...
        return f"{hour} hours and {min} mins"
...
class Review(models.Model):
    ...
    def timestamp_as_date(self):
        return datetime.strftime(self.timestamp, "%b %d, %Y")